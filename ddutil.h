...
public:
	...
	HRESULT DrawBitmapPart( HBITMAP hBMP, DWORD dwDestX, DWORD dwDestY, DWORD dwBMPOriginX, 
							DWORD dwBMPOriginY, DWORD dwBMPWidth, DWORD dwBMPHeight );
	...
	HRESULT Clear(DWORD dwFillColor);
    HRESULT Destroy();
